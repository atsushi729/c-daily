...
from cdl.constants import CLAUDE_PROJECTS_DIR, TOOL_INPUT_PREVIEW_LEN
from cdl.models import MessageRecord, ProjectItem, SessionMeta
from cdl.diff_utils import _make_diff
...
class TUI:
    ...
    def _draw_list(
        ...
        for i in range(visible):
            ...
            raw_title = s.first_msg or s.project_name
    ...
    def _draw_messages(
        ...
        header_rows = 3
        session_title = (s.first_msg or s.project_name).replace("\n", " ").replace("\r", " ")
