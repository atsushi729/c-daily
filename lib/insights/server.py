"""
insights/server.py - Lightweight HTTP server for the c-daily web UI.
...
from insights._templates import (  # noqa: E402
    index_html,
    not_found_html,
    project_html,
    session_html,
)
from insights.extractor import (  # noqa: E402
    activity_heatmap,
    project_detail,
    project_list,
    session_data,
